const CONFIG_KEY = 'retirement-sim-config-v0.8';
const LEGACY_CONFIG_KEYS = ['retirement-sim-config-v0.7','retirement-sim-config-v0.6','retirement-sim-config-v0.5','retirement-sim-config-v0.4','retirement-sim-config-v0.3','retirement-sim-config-v0.2'];
const SCENARIO_KEY = 'retirement-sim-scenarios-v0.8';
const LEGACY_SCENARIO_KEYS = ['retirement-sim-scenarios-v0.7','retirement-sim-scenarios-v0.6','retirement-sim-scenarios-v0.5','retirement-sim-scenarios-v0.4','retirement-sim-scenarios-v0.3'];
...
export function migrateConfig(config) {
  ...
  c.meta ||= {}; c.meta.schemaVersion = '0.8';
